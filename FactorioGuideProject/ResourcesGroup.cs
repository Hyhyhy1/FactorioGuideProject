...
namespace FactorioGuideProject
{
    class ResourcesGroup
    {
        ...
        {
            var group = new List<Label>();
            group.Add(new Label() { Text = "Камень", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Древесина", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Угольная руда",Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Медная руда", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Железная руда", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Вода", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Нефть", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Урановая руда", Dock = DockStyle.Fill });
            group.Add(new Label() { Text = "Рыба", Dock = DockStyle.Fill });
            return group.ToArray();
        }
    }
}
